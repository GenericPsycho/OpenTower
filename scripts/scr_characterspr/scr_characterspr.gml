function scr_characterspr()
{
	...
	if (character == "N" || (character == "P" && !ispeppino))
	{
		...
		spr_breakdance = !global.doisemode && !ispeppino ? spr_playerN_breakdancing : spr_playerN_opagangnamstyle
	...
	if character == "E"
	{
		spr_idle = spr_playerE_idle
		spr_move = spr_playerE_move
		spr_crawl = spr_playerE_crawl
		spr_idle = spr_playerE_idle
		spr_hurt = spr_playerE_hurt
		spr_jump = spr_playerE_jump
		spr_jump2 = spr_player_jump2
		spr_fall = spr_playerE_fall
		spr_fall2 = spr_player_fall2
		spr_crouch = spr_playerE_crouch
		spr_crouchjump = spr_playerE_crouchjump
		spr_crouchfall = spr_playerE_crouchfall
		spr_couchstart = spr_playerE_couchstart
		spr_bump = spr_playerE_bump
		spr_land = spr_playerE_land
		spr_land2 = spr_playerE_land2
		spr_lookdoor = spr_playerE_lookdoor
		spr_walkfront = spr_playerE_walkfront
		spr_victory = spr_playerE_victory
		spr_Ladder = spr_playerE_ladder
		spr_laddermove = spr_playerE_laddermove
		spr_ladderdown = spr_playerE_ladderdown
		spr_keyget = spr_playerE_keyget
		spr_crouchslip = spr_playerE_crouchslip
		spr_pistolshot = spr_playerE_pistolshot
		spr_pistolwalk = spr_playerE_pistolwalk
		spr_longjump = spr_playerE_longjump
		spr_longjumpend = spr_playerE_longjumpend
		spr_breakdance = spr_playerE_breakdance
		spr_machslideboostfall = spr_playerE_machslideboostfall
		spr_mach3boostfall = spr_playerE_machslideboost3fall
		spr_mrpinch = spr_playerE_mrpinch
		spr_rampjump = spr_playerE_rampjump
		spr_mach1 = spr_playerE_mach1
		spr_mach = spr_playerE_mach
		spr_secondjump1 = spr_playerE_secondjump1
		spr_secondjump2 = spr_playerE_secondjump2
		spr_machslidestart = spr_playerE_machslidestart
		spr_machslide = spr_playerE_machslide
		spr_machslideend = spr_playerE_machslideend
		spr_machslideboost = spr_playerE_machslideboost
		spr_catched = spr_playerE_catched
		spr_land2 = spr_playerE_land2
		spr_punch = spr_playerE_punch
		spr_backkick = spr_player_backkick
		spr_shoulder = spr_player_shoulder
		spr_uppunch = spr_player_uppunch
		spr_stomp = spr_playerE_stomp
		spr_stompprep = spr_playerE_stompprep
		spr_crouchslide = spr_player_crouchslide
		spr_crouch = spr_playerE_crouch
		spr_bump = spr_playerE_bump
		spr_victory = spr_playerE_victory
		spr_hurt = spr_playerE_hurt
		spr_climbwall = spr_playerE_climbwall
		spr_grab = spr_player_grab
		spr_mach2jump = spr_playerE_mach2jump
		spr_Timesup = spr_playerE_timesup
		spr_deathstart = spr_player_deathstart
		spr_deathend = spr_playerE_deathend
		spr_machpunch1 = spr_playerE_machpunch1
		spr_machpunch2 = spr_playerE_machpunch2
		spr_hurtjump = spr_playerE_jumphurt
		spr_entergate = spr_playerE_entergate
		spr_gottreasure = spr_playerE_gottreasure
		spr_bossintro = spr_player_bossintro
		spr_hurtidle = spr_playerE_hurtidle
		spr_hurtwalk = spr_playerE_hurtwalk
		spr_suplexmash1 = spr_playerE_suplexmash1
		spr_suplexmash2 = spr_playerE_suplexmash2
		spr_suplexmash3 = spr_playerE_suplexmash3
		spr_suplexmash4 = spr_playerE_suplexmash4
		spr_tackle = spr_player_tackle
		spr_airdash1 = spr_player_airdash1
		spr_airdash2 = spr_player_airdash2
		spr_keyget = spr_playerE_keyget
		spr_idle1 = spr_playerE_idlefrown
		spr_idle2 = spr_playerE_idledance
		spr_idle3 = spr_playerE_handgesture1
		spr_idle4 = spr_playerE_handgesture2
		spr_idle5 = spr_playerE_handgesture3
		spr_idle6 = spr_playerE_handgesture4
		spr_wallsplat = spr_playerE_wallsplat
		spr_piledriver = spr_playerE_piledriver
		spr_piledriverland = spr_playerE_piledriverland
		spr_charge = spr_player_charge
		spr_mach3jump = spr_playerE_mach3jump
		spr_mach4 = spr_playerE_mach4
		spr_machclimbwall = spr_playerE_climbwall
		spr_dive = spr_playerE_dive
		spr_machroll = spr_playerE_machroll
		spr_hitwall = spr_playerE_mach3hitwall
		spr_superjumpland = spr_playerE_superjumpland
		spr_walljumpstart = spr_playerE_walljumpstart
		spr_superjumpprep = spr_playerE_superjumpprep
		spr_superjump = spr_playerE_superjump
		spr_superjumppreplight = spr_playerE_superjumppreplight
		spr_superjumpright = spr_playerE_superjumpright
		spr_superjumpleft = spr_playerE_superjumpleft
		spr_machfreefall = spr_playerE_machfreefall
		spr_mach3hit = spr_playerE_mach3hit
		spr_knightpepwalk = spr_knightplu_walk
		spr_knightpepjump = spr_knightplu_jump
		spr_knightpepfall = spr_knightplu_fall
		spr_knightpepidle = spr_knightplu_idle
		spr_knightpepjumpstart = spr_knightplu_jumpstart
		spr_knightpepthunder = spr_knightplu_thunder
		spr_knightpepland = spr_knightplu_land
		spr_knightpepdownslope = spr_knightplu_downslope
		spr_knightpepstart = spr_knightplu_start
		spr_knightpepcharge = spr_knightplu_charge
		spr_knightpepdoublejump = spr_knightplu_doublejump
		spr_knightpepfly = spr_knightplu_fly
		spr_knightpepdowntrust = spr_knightplu_downtrust
		spr_knightpepupslope = spr_knightplu_upslope
		spr_knightpepbump = spr_knightplu_bump
		spr_bodyslamfall = spr_playerE_bodyslamfall
		spr_bodyslamstart = spr_playerE_bodyslamstart
		spr_bodyslamland = spr_playerE_bodyslamland
		spr_crazyrun = spr_playerE_crazyrun
		spr_bombpeprun = spr_bombpep_run
		spr_bombpepintro = spr_bombpep_intro
		spr_bombpeprunabouttoexplode = spr_bombpep_runabouttoexplode
		spr_bombpepend = spr_bombpep_end
		spr_jetpackstart2 = spr_playerE_jetpackstart2
		spr_fireass = spr_playerE_fireass
		spr_fireassground = spr_playerE_fireassground
		spr_fireassend = spr_player_fireassend
		spr_tumblestart = spr_player_tumblestart
		spr_tumbleend = spr_playerE_tumbleend
		spr_tumble = spr_playerE_tumble
		spr_stunned = spr_player_stunned
		spr_clown = spr_player_clown
		spr_clownbump = spr_player_clownbump
		spr_clowncrouch = spr_player_clowncrouch
		...
		spr_clownjump = spr_player_clownjump
		spr_clownwallclimb = spr_player_clownwallclimb
		spr_downpizzabox = spr_playerE_downpizzabox
		spr_uppizzabox = spr_playerE_uppizzabox
		spr_slipnslide = spr_player_slipnslide
		spr_mach3boost = spr_playerE_machslideboost3
		spr_facehurtup = spr_playerE_facehurtup
		spr_facehurt = spr_playerE_facehurt
		spr_walljumpend = spr_playerE_walljumpend
		spr_suplexdash = spr_playerE_suplexdash
		spr_suplexdashjumpstart = spr_playerE_suplexgrabjumpstart
		spr_suplexdashjump = spr_playerE_suplexgrabjump
		spr_shotgunsuplexdash = spr_shotgun_suplexdash
		spr_rollgetup = spr_playerE_rollgetup
		spr_swingding = spr_playerE_swingding
		spr_swingdingend = spr_playerE_swingdingend
		spr_haulingjump = spr_playerE_haulingjump
		spr_haulingidle = spr_playerE_haulingidle
		spr_haulingwalk = spr_playerE_haulingwalk
		spr_haulingstart = spr_playerE_haulingstart
		spr_haulingfall = spr_playerE_haulingfall
		spr_haulingland = spr_playerE_haulingland
		spr_uppercutfinishingblow = spr_playerE_uppercutfinishingblow
		spr_finishingblow1 = spr_playerE_finishingblow1
		spr_finishingblow2 = spr_playerE_finishingblow2
		spr_finishingblow3 = spr_playerE_finishingblow3
		spr_finishingblow4 = spr_playerE_finishingblow4
		spr_finishingblow5 = spr_playerE_finishingblow5
		spr_winding = spr_playerE_winding
		spr_3hpwalk = spr_playerE_3hpwalk
		spr_3hpidle = spr_playerE_3hpidle
		spr_panic = spr_playerE_panic
		spr_facestomp = spr_playerE_facestomp
		spr_freefall = spr_playerE_freefall
		spr_shotgunland = spr_plumeshotgun_land
		spr_shotgunshoot = spr_playerE_shotgun
		spr_shotgunidle = spr_plumeshotgun_idle
		spr_shotgunwalk = spr_plumeshotgun_walk
		spr_shotgunfall = spr_plumeshotgun_fall
		spr_shotgunjump = spr_plumeshotgun_jump
		spr_shotgunjump1 = spr_playerE_shotgunjump1
		spr_shotgunjump2 = spr_playerE_shotgunjump2
		spr_shotgunjump3 = spr_playerE_shotgunjump3
		spr_shotgunpullout = spr_plumeshotgun_pullout
		spr_shotgunduck = spr_plumeshotgun_duck
		spr_shotguncrawl = spr_plumeshotgun_crawl
		spr_shotgungoduck = spr_plumeshotgun_goduck
		spr_fightball = spr_playerE_fightball
		spr_squished = spr_player_squished
		spr_supertaunt1 = spr_playerE_supertaunt1
		spr_supertaunt2 = spr_playerE_supertaunt2
		spr_supertaunt3 = spr_playerE_supertaunt3
		spr_supertaunt4 = spr_playerE_supertaunt4
		spr_taunt = spr_playerE_taunt
		spr_rideweenie = spr_playerE_weeniemount
		spr_weenieturn = spr_playerE_weenieturn
		spr_barrelidle = spr_playerE_barrelidle
		spr_barreljump = spr_playerE_barreljump
		spr_barrelroll = spr_playerE_barrelroll
		spr_barrelfall = spr_playerE_barrelfall
		spr_barrelslipnslide = spr_playerE_barrelslipnslide
		spr_barrelmove = spr_playerE_barrelmove
		spr_barrelland = spr_playerE_barrelland
		spr_breakdancesuper = spr_player_breakdancesuper
		spr_dashpadmach = spr_playerE_dashpad
		spr_firemouthintro = spr_playerE_firemouthintro
		spr_firemouthend = spr_playerE_firemouthend
		spr_firemouth = spr_playerE_firemouth
		spr_firemouthspin = spr_playerE_firemouthspin
		spr_firemouthdash = spr_playerE_firemouthdash
		spr_firemouthidle = spr_playerE_firemouthidle
		spr_ghostdash = spr_playerE_ghostdash
		spr_ghostdashright = spr_playerE_ghostdashright
		spr_ghostdashdown = spr_playerE_ghostdashdown
		spr_ghostdashdownright = spr_playerE_ghostdashdownright
		spr_ghostdashup = spr_playerE_ghostdashup
		spr_ghostdashupright = spr_playerE_ghostdashupright
		spr_ghostidle = spr_playerE_ghostidle
		spr_ghostend = spr_player_ghostend
		spr_ghostjump = spr_playerE_ghostjump
		spr_playercorpsestart = spr_playerE_corpsestart
		spr_playercorpsesurf = spr_playerE_corpsesurf
		spr_mortdoublejumpstart = spr_playerE_mortdoublejump
		spr_mortdoublejump = spr_playerE_mortjump
		spr_playermortidle = spr_playerE_mortidle
		spr_playermortjump = spr_playerE_mortjump
		spr_playermortjumpstart = spr_playerE_mortjumpstart
		spr_playermortland = spr_playerE_mortland
		spr_playermortwalk = spr_playerE_mortwalk
		spr_scaredjump1 = spr_playerE_scaredjump1
		spr_scaredjump2 = spr_playerE_scaredjump2
		spr_currentplayer = spr_playerE_current
		spr_golfidle = spr_playerE_golfidle
		spr_golfswing = spr_playerE_golfswing
		spr_cheeseballplayer = spr_playerE_cheeseball
		spr_boxxedpepintro = spr_boxxedplu_intro
		spr_boxxedpepidle = spr_boxxedplu_idle
		spr_boxxedpepwalk = spr_boxxedplu_walk
		spr_boxxedpepair = spr_boxxedplu_air
		spr_cheesepepintro = spr_cheeseplu_intro
		spr_cheesepepidle = spr_cheeseplu_idle
		spr_cheesepepwalk = spr_cheeseplu_walk
		spr_cheesepepjump = spr_cheeseplu_jump
		spr_cheesepepjumpstart = spr_cheeseplu_jumpstart
		spr_cheesepepfall = spr_cheeseplu_fall
		spr_cheesepepland = spr_cheeseplu_land
		spr_cheesepepstickside = spr_cheeseplu_stickwall
		spr_cheesepepstickceiling = spr_cheesepep_stickceilling
		spr_cheesepepstickfloor = spr_cheesepep_stick
		spr_rocketstart = spr_playerE_rocketstart
		spr_rocket = spr_playerE_rocket
		spr_rockethitwall = spr_playerE_rockethitwall
		spr_slipbanan1 = spr_playerE_slipbanan1
		spr_slipbanan2 = spr_playerE_slipbanan2
		spr_rageidle = spr_playerE_rageidle
		spr_ragemove = spr_playerE_ragemove
		spr_parry1 = spr_playerE_parry1
		spr_parry2 = spr_playerE_parry2
		spr_parry3 = spr_playerE_parry3
		spr_dead = spr_playerE_deathend
		spr_suplexbump = spr_playerE_suplexbump
		spr_grind = spr_playerE_grind
		spr_suplexland = spr_playerE_backflip
		spr_superspringplayer = spr_playerE_presentbox
		spr_suplexcancel = spr_playerE_suplexcancel
		spr_mortthrow = spr_player_mortthrow
		spr_palette = spr_plupalette
		spr_backslide = spr_playerE_backslide
		spr_backslideland = spr_playerE_backslideland
		spr_breakdanceuppercut = spr_playerE_breakdanceuppercut
		spr_breakdanceuppercutend = spr_playerE_breakdanceuppercutend
	}
	if character == "R"
	{
		spr_idle = spr_player_idle
