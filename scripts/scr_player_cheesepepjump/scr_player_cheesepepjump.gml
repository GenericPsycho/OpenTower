function scr_player_cheesepepjump()
{
	...
	{
		if (sprite_index == spr_cheesepepjumpstart || sprite_index == spr_cheesepep_walljump || sprite_index == spr_playerN_cheesedwalljump || sprite_index == spr_cheeseplu_walljump)
