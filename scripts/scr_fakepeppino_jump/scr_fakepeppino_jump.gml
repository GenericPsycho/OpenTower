function scr_fakepeppino_jump()
{
	...
	if ((sprite_index == spr_fakepeppino_jump || sprite_index == spr_ditto_jump) && floor(image_index) == image_number - 1)
	{
		image_index = 0;
		sprite_index = obj_player1.character == "E" ? spr_ditto_fall : spr_fakepeppino_fall;
	}
	if ((place_meeting(x, y + 1, obj_solid) || place_meeting(x, y + 1, obj_slope) || place_meeting(x, y + 1, obj_platform)) && (sprite_index == spr_fakepeppino_fall || sprite_index == spr_ditto_fall))
	{
		image_index = 0;
