...
if ((state == states.grabdash || (state == states.mach2 && attackspeed >= 10) || (state == states.throwing && (sprite_index == spr_fakepeppino_flailing || sprite_index == spr_ditto_flailing)) || state == states.freefall) && alarm[0] == -1)
{
	alarm[0] = 10;
