...
var plat = "Desktop";
var banks = [concat("sound/", plat, "/Master.bank"), concat("sound/", plat, "/music.bank"), concat("sound/", plat, "/modded-music.bank"), concat("sound/", plat, "/sfx.bank"), concat("sound/", plat, "/modded-sfx.bank"), concat("sound/", plat, "/Master.strings.bank")]
