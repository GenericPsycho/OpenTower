...
if (place_meeting(x, y, obj_player))
{
	...
	if voicecooldown == 0
	{
		fmod_event_one_shot_3d(FF ? "event:/modded-sfx/voice/youarenotgranny" : "event:/modded-sfx/voice/questgranny", x, y)
		voicecooldown = 100
	}
}
else
...
switch text_state
{
	case states.titlescreen:
		...
		if (obj_player1.state != states.backtohub && place_meeting(x, y, obj_player) && !_hide)
		{
			...
			text_vsp = 0;
			if (object_index == obj_tutorialquest && ds_list_find_index(global.saveroom, id) == -1)
			{
