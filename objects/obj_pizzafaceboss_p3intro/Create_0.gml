noisesprite = obj_player1.character == "E" && !global.swapmode ? spr_wobbuffet_vulnerablesmile : spr_playerN_panicidle;
fakepepsprite = obj_player1.character == "E" && !global.swapmode ? spr_ditto_vulnerable : spr_fakepeppino_intro3loop;
...
proparr = [
	...
	[spr_playerN_hurt, noisesprite, spr_player_mask, -5],
	[spr_fakepeppino_stun, fakepepsprite, spr_player_mask, -4]
];
with (obj_music)
{
    if (music != noone)
