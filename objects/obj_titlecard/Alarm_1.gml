...
if (titlecard_sprite == spr_titlecardsecret || titlecard_sprite == spr_titlecardsecretN || titlecard_sprite == spr_titlecardsecretD || titlecard_sprite == spr_titlecardsecretS || titlecard_sprite == spr_titlecardsecretSD || titlecard_sprite == spr_titlecardsecretE) && !global.extras_betternoise
{
...
for (i = 0; i < array_length(noisespots); i++)
{
	...
	var head = 
	{
		...
		visual_scale: 1,
		visible: false,
		image_index: irandom(sprite_get_number(global.solitude ? spr_titlecard_solitude : (global.doisemode ? spr_titlecard_doise : spr_titlecard_noise)) - 1)
	}
